class Mostro {
  ...
  takeHit() {
    ...
    if (this.health <= 0) {
      ...
      if (typeof giveXP === "function") giveXP("l1_monster_kill");
    }
  }
  ...
  const onGround = this.y >= window.innerHeight - 400; // Verifica se il mostro è a terra
  ...
  if (!onGround || this.velocityY < 0) {
    ...
    this.y = window.innerHeight - 400; // Posiziona il mostro a terra
    this.isInAir = false;
  }
