...
function updateLevel1Hud(health, score) {
  ...
  if (lvlEl) lvlEl.textContent = "Stage 1 | Player Lv 1";
...
function Game() {
  ...
  this.gravity = 0.4;
  this.backgroundMusic = new Audio("/game/livello1/sounds/musica_sfondo.mp3");
  ...
  this.customCursor.src = "/game/livello1/img/cursore.png";  // Percorso dell'immagine del cursore
  ...
  this.loadAssets = async function (callback) {
    try {
      await Promise.all([
        ...
        loadImage("/game/livello1/Primo_Mostro/Idle.png"),
        loadImage("/game/livello1/Primo_Mostro/Walk.png"),
        loadImage("/game/livello1/Primo_Mostro/Run.png"),
        loadImage("/game/livello1/Primo_Mostro/Attack_1.png"),
        loadImage("/game/livello1/Primo_Mostro/Attack_2.png"),
        loadImage("/game/livello1/Primo_Mostro/Attack_3.png"),
        loadImage("/game/livello1/Primo_Mostro/Dead.png"),

        // Immagini Secondo Mostro
        loadImage("/game/livello1/Secondo_Mostro/Idle.png"),
        loadImage("/game/livello1/Secondo_Mostro/Walk.png"),
        loadImage("/game/livello1/Secondo_Mostro/Run.png"),
        loadImage("/game/livello1/Secondo_Mostro/Attack_1.png"),
        loadImage("/game/livello1/Secondo_Mostro/Attack_2.png"),
        loadImage("/game/livello1/Secondo_Mostro/Attack_3.png"),
        loadImage("/game/livello1/Secondo_Mostro/Dead.png"),

        // Cuori
        loadImage("/game/livello1/CuoriGioco/3cuori.png"),
        loadImage("/game/livello1/CuoriGioco/2cuori.png"),
        loadImage("/game/livello1/CuoriGioco/1cuore.png"),
        loadImage("/game/livello1/CuoriGioco/0cuori.png"),

        // Game Over
        loadImage("/game/livello1/img/gameOver.png"),
      ]);

      // Assegnazione immagini cuori e game over (puoi rimuovere se non usi altrove)
      this.heart3.src = "/game/livello1/CuoriGioco/3cuori.png";
      this.heart2.src = "/game/livello1/CuoriGioco/2cuori.png";
      this.heart1.src = "/game/livello1/CuoriGioco/1cuore.png";
      this.heart0.src = "/game/livello1/CuoriGioco/0cuori.png";

      this.gameOverImage.src = "/game/livello1/img/gameOver.png";
      ...
      this.background1 = new Image(); this.background1.src = "/game/livello1/img/livello1.png";

      // Primo mostro
      this.sprMonsterIdle = new Image(); this.sprMonsterIdle.src = "/game/livello1/Primo_Mostro/Idle.png";
      this.sprMonsterWalk = new Image(); this.sprMonsterWalk.src = "/game/livello1/Primo_Mostro/Walk.png";
      this.sprMonsterRun = new Image(); this.sprMonsterRun.src = "/game/livello1/Primo_Mostro/Run.png";
      this.sprMonsterAttack1 = new Image(); this.sprMonsterAttack1.src = "/game/livello1/Primo_Mostro/Attack_1.png";
      this.sprMonsterAttack2 = new Image(); this.sprMonsterAttack2.src = "/game/livello1/Primo_Mostro/Attack_2.png";
      this.sprMonsterAttack3 = new Image(); this.sprMonsterAttack3.src = "/game/livello1/Primo_Mostro/Attack_3.png";
      this.sprMonsterDead = new Image(); this.sprMonsterDead.src = "/game/livello1/Primo_Mostro/Dead.png";

      // Secondo mostro
      this.sprSecondMonsterIdle = new Image(); this.sprSecondMonsterIdle.src = "/game/livello1/Secondo_Mostro/Idle.png";
      this.sprSecondMonsterWalk = new Image(); this.sprSecondMonsterWalk.src = "/game/livello1/Secondo_Mostro/Walk.png";
      this.sprSecondMonsterRun = new Image(); this.sprSecondMonsterRun.src = "/game/livello1/Secondo_Mostro/Run.png";
      this.sprSecondMonsterAttack1 = new Image(); this.sprSecondMonsterAttack1.src = "/game/livello1/Secondo_Mostro/Attack_1.png";
      this.sprSecondMonsterAttack2 = new Image(); this.sprSecondMonsterAttack2.src = "/game/livello1/Secondo_Mostro/Attack_2.png";
      this.sprSecondMonsterAttack3 = new Image(); this.sprSecondMonsterAttack3.src = "/game/livello1/Secondo_Mostro/Attack_3.png";
      this.sprSecondMonsterDead = new Image(); this.sprSecondMonsterDead.src = "/game/livello1/Secondo_Mostro/Dead.png";
...
this.GameLoop = () => {
  ...
  this.Draw = function () {
      ...
      window.addEventListener('click', (e) => {
        ...
        if (clickX >= this.canvas.width / 2 - 150 && clickX <= this.canvas.width / 2 + 150) {
          if (clickY >= this.canvas.height / 2 + 80 && clickY <= this.canvas.height / 2 + 110) {
            window.location.href = "../../livello1/livello1.html"; // Passa al prossimo livello
          }
        }
      });
    ...
    if (this.player) {
      ...
      updateLevel1Hud(this.player.health, this.score);
    }
  ...
  this.StartGame = async function () {
    ...
    this.storyController = startStoryRotation([
      "La gola di Velkan si apre davanti a te: ogni passo risveglia antichi guardiani.",
      "Il vento porta eco di lame antiche. Mantieni il ritmo e non cedere terreno.",
      "Oltre la nebbia c'e la prima chiave del destino: resta lucido e avanza."
    ]);
  ...
  this.completeLevel = async () => {
    ...
    await giveXP("l1_level_complete");
    await unlockPlayableLevel(3);
    setTimeout(() => {
      window.location.href = "http://localhost:4000/index/index.html";
    }, 1400);
  };
